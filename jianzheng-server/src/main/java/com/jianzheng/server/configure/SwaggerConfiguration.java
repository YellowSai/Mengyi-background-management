...
public class SwaggerConfiguration {
    ...
    public Docket apiDocket() {
        return newGroupDocket("对外接口", "com.jianzheng.server.controller.api", "accessToken");
    }
    ...
    public Docket admApiDocket() {
        return newGroupDocket("管理后台接口", "com.jianzheng.server.controller.admapi", AuthConsts.AUTHORIZATION_HEADER);
    }
